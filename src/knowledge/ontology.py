...
def seed_entries() -> list[OntologyEntry]:
    return [
        ...
        OntologyEntry("E11.9", "Type 2 diabetes mellitus without complications", SYSTEM_ICD10, TYPE_DIAGNOSIS, ("\u0111\u00e1i th\u00e1o \u0111\u01b0\u1eddng type 2", "\u0111\u00e1i th\u00e1o \u0111\u01b0\u1eddng", "ti\u1ec3u \u0111\u01b0\u1eddng type 2", "ti\u1ec3u \u0111\u01b0\u1eddng", "type 2 diabetes", "diabetes mellitus"), 10),
        ...
        OntologyEntry("J47", "Bronchiectasis", SYSTEM_ICD10, TYPE_DIAGNOSIS, ("gi\u00e3n ph\u1ebf qu\u1ea3n", "bronchiectasis"), 10),
        OntologyEntry("A08.4", "Viral intestinal infection, unspecified", SYSTEM_ICD10, TYPE_DIAGNOSIS, ("vi\u00eam d\u1ea1 d\u00e0y ru\u1ed9t do virus", "vi\u00eam d\u1ea1 d\u00e0y - ru\u1ed9t do virus", "viral gastroenteritis", "viral intestinal infection"), 8),
        OntologyEntry("A09", "Other gastroenteritis and colitis of infectious and unspecified origin", SYSTEM_ICD10, TYPE_DIAGNOSIS, ("vi\u00eam d\u1ea1 d\u00e0y ru\u1ed9t", "vi\u00eam d\u1ea1 d\u00e0y - ru\u1ed9t", "gastroenteritis"), 12),
