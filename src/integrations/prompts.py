...
def build_decision_prompt(text: str, mentions: list[dict[str, Any]]) -> str:
    payload = {
        ...
        "rules": [
            ...
            "For RxNorm, if the mention includes strength/form, prefer candidates with matching strength/form over ingredient-only codes.",
            "For ICD-10, prefer the most specific matching diagnosis code; include multiple sibling codes only when the mention is clinically ambiguous and the candidates are all directly relevant.",
